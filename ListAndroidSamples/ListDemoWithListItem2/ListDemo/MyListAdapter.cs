...
namespace ListDemo
{
    ...
    public class MySomeDataListAdapter : MyListAdapter<SomeData>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Android.Resource.Id.Text1).Text = _items[position].Number.ToString();
            view.FindViewById<TextView>(Android.Resource.Id.Text2).Text = _items[position].Text;
            return view;
        }
    }
}